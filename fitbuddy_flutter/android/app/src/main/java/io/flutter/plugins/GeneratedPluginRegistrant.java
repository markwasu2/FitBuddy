...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.confidosoft.health_kit.HealthKitPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin health_kit, com.confidosoft.health_kit.HealthKitPlugin", e);
    }
    try {
