...
class GoogleFitProvider {
  static const String _channelName = 'google_fit_provider';
  ...
  ProviderId get providerId => ProviderId.googleFit;
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (_isAuthorized) {
        debugPrint('Google Fit authorized successfully');
      } else {
        debugPrint('Google Fit authorization failed');
      }
    } catch (e) {
      debugPrint('Error initializing Google Fit provider: $e');
    } finally {
      _isLoading = false;
    }
  }
